" vrunchbang-light, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#485154'
  let g:terminal_color_8 =  '#949494'
  let g:terminal_color_9 =  '#e06a26'
  let g:terminal_color_10 = '#e0e0e0'
  let g:terminal_color_11 = '#bfbfbf'
  let g:terminal_color_12 = '#707e82'
  let g:terminal_color_13 = '#3b4245'
  let g:terminal_color_14 = '#d46a84'
  let g:terminal_color_15 = '#2e3436'
endif
...
if filereadable(expand('~/.nightshell/vrunchbang-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/vrunchbang-light'
  endif
endif
...
augroup NightsenseThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vrunchbang-light | endif'
augroup END
let colors_name = 'vrunchbang-light'
...
if exists('g:vrunchbang_light_CursorLineNr')
if g:vrunchbang_light_CursorLineNr == 'off'
